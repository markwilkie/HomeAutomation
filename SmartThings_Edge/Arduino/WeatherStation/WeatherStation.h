...
#define SWITCHTOTOBAT         5.2                   // voltage that ESP will switch to battery power (e.g. turn off boost)
#define SWITCHTOTOCAP         4.9                   // voltage that ESP will switch to capacitor power (turn on boost)
