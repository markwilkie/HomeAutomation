...
//Or, 1241 per volt on a 12bit ADC and 3.3v
//....
//Pa = ((ADC/1241)*1000) where Pa is Pascals and ADC is the adc reading raw
//
//Density of Air at sealevel and 20c is 1.204 kg/m^3
//therefore...
//m/s Velocity = sqrt(2*(Pa/1.204))
//and...
//MPH = Velocity*2.23694  (Meters per second)
//
//Put together:
