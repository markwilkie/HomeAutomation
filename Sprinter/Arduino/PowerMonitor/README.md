...
- **Red with grey fill (DEVICE_STALE or DEVICE_OFFLINE)** - Device is disconnected, stale, or in backoff mode. Grey meter fill indicates not receiving current data. Last known values displayed.
