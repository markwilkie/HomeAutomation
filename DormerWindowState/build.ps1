<#
.SYNOPSIS
  Build and flash script for the Dormer Window State Matter sensor (native
  Windows). Windows equivalent of build.sh.

.PARAMETER Target
  IDF target chip. Defaults to esp32c6.
...
Write-Host "=========================================="
Write-Host "Dormer Window State Build Script"
Write-Host "=========================================="
...
Write-Host "Configure under 'Dormer Window State Configuration':"
Write-Host "  - WINDOW_SENSOR_GPIO (which pin the reed switch is wired to)"
Write-Host "  - WINDOW_SENSOR_ACTIVE_LOW (wiring polarity)"
