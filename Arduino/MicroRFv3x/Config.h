...
#define STATE_PAYLOADSIZE 15            // Size of package we're sending over the wire
#define STATE_PAYLOADSIZE_ADC 18        // Size of package we're sending over the wire w/ ADC
